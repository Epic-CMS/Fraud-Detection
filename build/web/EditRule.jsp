...
<html>
    ...
    <body>
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-indent nav_icon"></i>Rules<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="CreateNewRule.jsp">Create New</a>
                                    </li>
                                    <li>
                                        <a href="EditRule.jsp">Edit Rules</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
            ...
            <div id="page-wrapper">
                <div class="graphs">
                    <div align="center"><font size="4" color="black"><b>Edit Rule</b><br><br></font></div>
                    ...
                    <div id="buttonOne" class="col-md-6 widget_1_box2">
